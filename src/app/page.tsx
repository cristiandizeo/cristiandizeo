...
const AboutContent = () => (
  <div className="p-8 max-w-4xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 gap-8">
      <div>
        <div className="w-48 h-48 mx-auto mb-6 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-6xl">
          👨‍💻
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            innovadoras. Con experiencia en tecnologías modernas, me especializo
            en desarrollar aplicaciones escalables y experiencias de usuario
            excepcionales.
          </p>
        </div>
    ...
    <div className="grid md:grid-cols-2 gap-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8">
          ¿Tienes un proyecto en mente? Me encantaría saber más sobre tu idea y
          cómo puedo ayudarte a hacerla realidad.
        </p>
...
const getFileIcon = (file: NavigableFile): JSX.Element | string => {
  ...
  if (file.fileName.endsWith('.tsx')) return <DiReact className="text-cyan-400 dark:text-cyan-300" size={16} />;
  if (file.fileName.endsWith('.jsx')) return <DiReact className="text-cyan-400 dark:text-cyan-300" size={16} />;
  if (file.fileName.endsWith('.blade.php')) return <FaLaravel size={16} className='text-red-600' />;
  if (file.fileName.endsWith('.php')) return <FaPhp size={24} className='text-blue-400' />;
  return '📄';
};
...
export default function VSCodePortfolio(): JSX.Element {
  ...
  const allFiles = [...sections, ...projects];
...
<div className="flex w-full min-h-svh bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-mono transition-colors duration-300">
  {/* Sidebar */}
  <div
    className={`${sidebarCollapsed ? 'w-12' : 'w-56'} bg-gray-100 dark:bg-gray-800 border-r 
